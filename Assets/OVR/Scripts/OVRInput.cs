...
public static class OVRInput
{
    ...
    public static void Update()
	{
        ...
        // Promote TrackedRemote to Active if one is connected and no other controller is active // here modify == Controller.None with > 0 ! is predefined, should revert change back
